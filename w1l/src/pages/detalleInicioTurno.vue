...
const agregarModificacionEmpleados = () => {
    formModEmpleados.value.validate().then(response => {
        if (response.valid) {
            ...
            const encCajaEliminado = datosEmpleadosResumen.value.every(
                empleado => empleado.esRespDeApertCaja === false
            );
            if (encCajaEliminado) {
                        ...
                        <VTable>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ${{ datosCajaResumen.importeInicial - datosCajaResumen.activoInicial }}
                                    </td>
                                </tr>
                            </tbody>
                        </VTable>
