      ...
      >
        <VRow>
            ...
            >
                <VRow>
                    ...
                    <VCol
                        ...
                        md="12"
                    >
                        <VChip v-if="aperturaCorrecta" color="success">
                            Apertura correcta
                        </VChip>
                        <VChip v-else-if="aperturaCorrecta == false" color="error">
                            Apertura incorrecta
                        </VChip>
                    </VCol>
                </VRow>
            ...
            <VCol
                ...
                class="d-flex gap-4"
            >
                <VBtn prepend-icon="ri-arrow-left-line" @click="emit('backToInicioDeTurno')"> Atrás </VBtn>
